...
public class HangManUI extends Pane {
    ...
    private void initNorthToolbar() {
        ...
        gameButton = initToolbarButton(northToolbar,HangManPropertyType.GAME_IMG_NAME);
        ...
        gameButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                eventHandler .respondToSwitchScreenRequest(HangManUIState.PLAY_GAME_STATE);
        ...
        statsButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                eventHandler.respondToSwitchScreenRequest(HangManUIState.VIEW_STATS_STATE);
        ...
        helpButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                eventHandler.respondToSwitchScreenRequest(HangManUIState.VIEW_HELP_STATE);
    ...
    private void initGameScreen() {
        ...
        gameSwingNode.setContent(guessesScrollPane); 
         ...
         //workspace.getChildren().add(guessesScrollPane);
       ...
       // hmPane.autosize();
        ...
        //  PropertiesManager propsb = PropertiesManager.getPropertiesManager();
        String newGameImageName = props
                .getProperty(HangManPropertyType.NEW_GAME_IMG_NAME);

        // LOAD THE IMAGE
        Image newGameImage = loadImage(newGameImageName);
        // ImageIcon imageIcon = new ImageIcon(image);
        ImageView newGameImageIcon = new ImageView(newGameImage);

        // MAKE THE BUTTON
        
        newGameButton.setGraphic(newGameImageIcon);
        // button.addKeyListener(cheatKeyHandler);
        ...
        ArrayList<String> letters = props .getPropertyOptionsList(HangManPropertyType.LETTER_OPTIONS);
               

        // WE'LL STORE THE ALPHABET LETTERS IN A NICE EASY TO ACCESS HASH TABLE
        letterButtons = new HashMap();
        String fontFamily = props .getProperty(HangManPropertyType.LETTERS_FONT_FAMILY);
               
        int fontSize = Integer.parseInt(props  .getProperty(HangManPropertyType.LETTERS_FONT_SIZE));
        ...
        for (int i = 0; i < letters.size(); i++) {
            ...
            letterButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    // TODO Auto-generated method stub
                    if(gsm.isGameOver() == true){
                           for (int i = 0; i < letterButtons.size(); i++) {
                           letterButtons.get(i).setDisable(true);
                           }
                           }
                    eventHandler.respondToGuessWordRequest(event.getSource(), guess);
    ...
    private void initHelpPane() {
        ...
        //helpScrollPane.setAlignment(Pos.CENTER);
        ...
        helpToolbar.setPrefSize(helpPanel.getMaxWidth(),60);
        //helpToolbar.setAlignment(Pos.CENTER);
        //helpToolbar.setAlignment(Pos.CENTER);
